...
impl ToTokens for Ty {
    fn to_tokens(&self, tokens: &mut pm2::TokenStream) {
        let ts = match self {
            ...
            Ty::F64 => quote! { f64 },
            Ty::F128 => quote! { f128 },
            Ty::ComplexF16 => quote! { compiler_builtins::float::Complex<f16> },
            Ty::ComplexF32 => quote! { compiler_builtins::float::Complex<f32> },
            Ty::ComplexF64 => quote! { compiler_builtins::float::Complex<f64> },
            Ty::ComplexF128 => quote! { compiler_builtins::float::Complex<f128> },
            Ty::I32 => quote! { i32 },
            Ty::I64 => quote! { i64 },
            Ty::I128 => quote! { i128 },
            Ty::U32 => quote! { u32 },
